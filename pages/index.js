...
offerDetails && console.log("herobannerdataaaaaaaaaaaaaaaa", offerDetails[0].offerHeader, offerDetails[0].offerDescription)
...
<div class="wavecontainer" style={{ position: "absolute",bottom:"0%",width:"100%"}}>
...
<Item rowStart={1} rowEnd={1}   paddingTop="5rem"    colStart={2} colEnd={5}  >
   <div style={{paddingTop:"12px"}}>
   { heroBannerData2 && heroBannerData2[0].heroTitle.titleArray.map(item=>{
  ...
  <span style={{fontSize:"30px",color:"#000000",fontWeight:"700",lineHeight:"37px"}}>{item} </span>
     </span> :  <span style={{fontSize:"16px",color:"#000000",fontWeight:"400",lineHeight:"21.79px"}}>
        
        <span style={{fontSize:"30px",color:"#D31424",fontWeight:"700",lineHeight:"37px"}}>{item} </span>
           </span>
...
const sample2 = ({ data }) => {
  ...
  heroBannerData &&
    console.log("herobannerdataaaaaaaaaaaaaaaa", heroBannerData[0].heroTitle);
      ...
      >
        ...
        >
          ...
          <div style={{ paddingTop: "12px" }}>
            ...
            >
              Driven by the desire to create a product that gives your feet an
              incredible experience, and to provide that sensation for every
              event in your life. Every step is a comfort
            </span>
          </div>
          <ButtonComponent
            width={142}
