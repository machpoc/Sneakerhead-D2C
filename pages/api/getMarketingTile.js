...
export default function api(req, res) {
  axios(
    `https://${process.env.CONTENTFUL_HOST}/spaces/${process.env.CONTENTFUL_SPACE}/environments/master/entries?access_token=${process.env.CONTENTFUL_TOKEN}&content_type=marketingTiles`
  )
    .then((resp) => resp.data)
    .then((data) => {
      const MarketingData = [
