...
import { StyledHeader, StyledList, StyledListItem, StyledMenuList, StyledMenuListItem, StyledOption, StyledSelect } from "./Navbar.styled";
          ...
          <StyledListItem>
              ...
              <a href="#">
                <svg
                  ...
                  height="18"
                  viewBox="0 0 18 18"
                  fill={`var(--sneakerhead-charcoal-black)`}
              ...
              >
                ...
                >
                  <path
                    d="M15.4411 11C16.1862 11 16.8418 10.59 17.1796 9.97L20.7361 3.48C21.1036 2.82 20.6268 2 19.8718 2H5.16915L4.23533 0H0.986847V2H2.97369L6.55001 9.59L5.20889 12.03C4.48369 13.37 5.43737 15 6.94737 15H18.8684V13H6.94737L8.04014 11H15.4411ZM6.1129 4H18.183L15.4411 9H8.46731L6.1129 4ZM6.94737 16C5.85461 16 4.97047 16.9 4.97047 18C4.97047 19.1 5.85461 20 6.94737 20C8.04014 20 8.93422 19.1 8.93422 18C8.93422 16.9 8.04014 16 6.94737 16ZM16.8816 16C15.7888 16 14.9047 16.9 14.9047 18C14.9047 19.1 15.7888 20 16.8816 20C17.9743 20 18.8684 19.1 18.8684 18C18.8684 16.9 17.9743 16 16.8816 16Z"
                    fill={`var(--sneakerhead-charcoal-black)`}
                  />
                </svg>
              </a>
